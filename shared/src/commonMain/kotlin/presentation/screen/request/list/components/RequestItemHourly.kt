        ...
        Row(
            ...
            Column(
                ...
                val pairHourAndMinute = subtractHourAndMinute(
                    str1 = requestItemData.startDate.removeTimezone(),
                    str2 = requestItemData.endDate.removeTimezone()
                )
                ...
                Text(
                    color = textColor, style = MaterialTheme.typography.subtitle2, text = duration
                )
